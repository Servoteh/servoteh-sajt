...
export const home: HomeContent = {
  ...
  kapaciteti: {
    ...
    slides: [
      ...
      { src: "/assets/about-precision-machining-room.webp", alt: "CNC precizna obrada u Servoteh pogonu", caption: "CNC precizna obrada" },
