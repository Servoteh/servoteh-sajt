...
export const detailBlocks: DetailBlock[] = [
  {
    ...
    bullets: [
      ...
      "Robotic handling of hot workpieces",
  ...
  cards: [
    ...
    },
    {
      ...
      specs: [
        ...
        "Workpiece-holder stroke: 500 mm",
    ...
    },
    {
      ...
      specs: [
        ...
        "Maximum workpiece diameter: 155 mm",
        "Maximum workpiece mass: 80 kg",
        "Deformation measurement during testing",
        "Pressure–deformation report and chart",
        "Pneumatic manipulator for heavy workpieces",
      ],
    },
    {
      img: "/assets/defence-tech/artillery-heat-treatment-line.webp",
      alt: "Heat treatment line — quenching, tempering, washing and transport of workpieces",
      title: "Heat treatment line",
      video: "tULt13jHqaw",
      desc: "A complete line for the heat treatment of shell bodies — normalising, quenching, annealing and tempering, with washing, degreasing and controlled cooling. Operating in a protective nitrogen atmosphere, with automated transport of workpieces and control via a Siemens PLC, with heat-treatment recipes and archiving of process parameters for stable, repeatable quality in series production.",
      specs: [
  ...
  cards: [
    {
      ...
      desc: "A vertical press for assembling projectile components with servo-driven transfer mechanisms. Sensor monitoring at each stage stops the process on deviation and protects the operator, the tooling and the workpiece.",
      specs: [
