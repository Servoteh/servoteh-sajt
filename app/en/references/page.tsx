...
import * as c from "@/content/en/reference";

export const metadata: Metadata = pageMetadata(c.meta, "/en/references/", "en");

// Each project card links to the corresponding deep page.
function caseHref(groupLabel: string): string {
  if (groupLabel === "Defence industry") return "/en/defence/";
  if (groupLabel === "General industry") return "/en/general-industrial-production/";
  // Special-purpose machines, lines and automation
  return "/en/special-purpose-machines/";
}
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* SELECTED PROJECTS — grouped by category */}
